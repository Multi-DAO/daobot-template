...
},{"./cjs/react-dom.production.min.js":"i17t"}],"QVnC":[function(require,module,exports) {
var define;
/**
...
},{"./factoryWithThrowingShims":"wVGV"}],"NYl1":[function(require,module,exports) {
var define;
/*
 *  big.js v5.2.2
...
},{}],"se9j":[function(require,module,exports) {
"use strict";
...
function Form(_ref) {
  var onSubmit = _ref.onSubmit,
      daoId = _ref.daoId,
      setDaoId = _ref.setDaoId,
      nftId = _ref.nftId,
      setNftId = _ref.setNftId,
  ...
  return /*#__PURE__*/_react.default.createElement("form", {
    ...
    htmlFor: "nft"
  }, "NFT account address:"), /*#__PURE__*/_react.default.createElement("input", {
    id: "nft",
    name: "nft",
    required: true,
    value: nftId,
...
},{"react":"n8MK","prop-types":"D9Od"}],"lY9v":[function(require,module,exports) {
"use strict";
...
var _SetupDaoForm = _interopRequireDefault(require("./components/SetupDaoForm"));
...
var BOATLOAD_OF_GAS = (0, _big.default)(3).times(Math.pow(10, 13)).toFixed();
...
var App = function App(_ref) {
  var contract = _ref.contract,
      ...
      wallet = _ref.wallet,
      nearApi = _ref.nearApi;

  var signIn = function signIn() {
    wallet.requestSignIn(nearConfig.contractName, "AutoDAO");
  };
  ...
  var _useState = (0, _react.useState)(localStorage.getItem("dao") || ""),
      _useState2 = _slicedToArray(_useState, 2),
      dao = _useState2[0],
      setDao = _useState2[1];

  var _useState3 = (0, _react.useState)(localStorage.getItem("nft") || ""),
      _useState4 = _slicedToArray(_useState3, 2),
      nft = _useState4[0],
      setNft = _useState4[1]; // save to local storage
  ...
  var registerDaoBotWithDao = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var daocontract, policy, newRole;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              alert("Please enter a dao address");
              return _context.abrupt("return");

            case 3:
              _context.next = 5;
              return new nearApi.Contract(wallet.account(), dao, {
            ...
            case 5:
              daocontract = _context.sent;
              _context.next = 8;
              return daocontract.get_policy();

            case 8:
              policy = _context.sent;
              newRole = _objectSpread(_objectSpread({}, policy.roles[1]), {}, {
                name: "DAO Bot",
                kind: {
              ...
              _context.next = 13;
              return daocontract.add_proposal({
                proposal: {
    ...
    return function registerDaoBotWithDao() {
      return _ref2.apply(this, arguments);
    };
  }();

  var registerCroncat = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var croncatContract, taskArgs, taskId;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              _context2.next = 5;
              return new nearApi.Contract(wallet.account(), "manager_v1.croncat.testnet", {
                changeMethods: ["create_task"],
                sender: wallet.getAccountId()
              });

            case 5:
              croncatContract = _context2.sent;
              taskArgs = {
              ...
              _context2.next = 9;
              return croncatContract.create_task(taskArgs, BOATLOAD_OF_GAS, "1000000000000000000000000");
    ...
    return function registerCroncat() {
      return _ref3.apply(this, arguments);
    };
  }(); // Use get_hash to check for created task: https://github.com/CronCats/cron-ui/blob/main/src/pages/Tasks.vue#L320


  return /*#__PURE__*/_react.default.createElement("main", null, /*#__PURE__*/_react.default.createElement("header", null, /*#__PURE__*/_react.default.createElement("h1", null, "AutoDAO Message"), currentUser ? /*#__PURE__*/_react.default.createElement("p", null, "Currently signed in as: ", /*#__PURE__*/_react.default.createElement("code", null, currentUser.accountId)) : /*#__PURE__*/_react.default.createElement("p", null, "Add an AutoDAO bot! Please login to continue."), currentUser ? /*#__PURE__*/_react.default.createElement("button", {
    onClick: signOut
  }, "Log out") : /*#__PURE__*/_react.default.createElement("button", {
    onClick: signIn
  }, "Log in")), currentUser && /*#__PURE__*/_react.default.createElement(_SetupDaoForm.default, {
    daoId: dao,
    setDaoId: function setDaoId(id) {
      return setDao(id);
    },
    setNftId: function setNftId(id) {
      return setNft(id);
    },
    nftId: nft,
    onSubmit: function onSubmit(e) {
      registerDaoBotWithDao();
      e.preventDefault();
    }
  }), currentUser && /*#__PURE__*/_react.default.createElement("p", null, "Click to go to the DAO and approve the proposal: ", /*#__PURE__*/_react.default.createElement("a", {
    href: "https://testnet-v2.sputnik.fund/#/" + dao,
    target: "_blank"
  }, "DAO Link")), currentUser && /*#__PURE__*/_react.default.createElement("button", {
    onClick: function onClick(e) {
      registerCroncat();
      e.preventDefault();
    }
  }, "Register Croncat"), currentUser && /*#__PURE__*/_react.default.createElement("p", null, " Try creating a new proposal to add a member to the dao, it should approve the proposal automatically if it owns a token of the nft ", nft || "none provided", "."));
};

App.propTypes = {
  contract: _propTypes.default.shape({}).isRequired,
  currentUser: _propTypes.default.shape({
    accountId: _propTypes.default.string.isRequired,
...
},{"regenerator-runtime/runtime":"QVnC","react":"n8MK","prop-types":"D9Od","big.js":"NYl1","./components/SetupDaoForm":"se9j"}],"itQ5":[function(require,module,exports) {
var CONTRACT_NAME = "dev-1648066012171-78504829951302";
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/rashi", "/.near/validator_key.json"),
...
},{"bn.js":"ZhQh","bs58":"GtuF","text-encoding-utf-8":"u2Lg","buffer":"dskh"}],"vXEo":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"buffer":"dskh"}],"BGME":[function(require,module,exports) {
/*!
 * depd
...
},{"depd":"BGME","setprototypeof":"br24","statuses":"DXbu","inherits":"Bm0n","toidentifier":"xY5n"}],"sgp1":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"depd":"BGME","./provider":"y4mD","../utils/web":"T1W2","../utils/errors":"jwOG","borsh":"cZjy","../utils/exponential-backoff":"sgp1","../utils/rpc_errors":"K54z","buffer":"dskh"}],"a8i6":[function(require,module,exports) {
"use strict";
/** @hidden @module */
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"js-sha256":"K2GL","./utils/enums":"bD1J","borsh":"cZjy","./utils/key_pair":"kvXx","buffer":"dskh"}],"dATY":[function(require,module,exports) {
'use strict';
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"bn.js":"ZhQh"}],"umBP":[function(require,module,exports) {
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"bn.js":"ZhQh","depd":"BGME","./transaction":"JiGz","./providers":"a8i6","borsh":"cZjy","./utils/key_pair":"kvXx","./utils/errors":"jwOG","./utils/rpc_errors":"K54z","./constants":"umBP","./utils/exponential-backoff":"sgp1","buffer":"dskh"}],"FFpR":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
'use strict';
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
...
},{"bn.js":"ZhQh","depd":"BGME","./account":"IEkm","./utils/format":"ynTt","./utils/key_pair":"kvXx","./transaction":"JiGz","./utils/web":"T1W2","buffer":"dskh"}],"nIgH":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"depd":"BGME","./account":"IEkm","./transaction":"JiGz","./utils":"bEEV","borsh":"cZjy","buffer":"dskh"}],"gdw7":[function(require,module,exports) {
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
function _initContract() {
  _initContract = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var nearConfig, near, walletConnection, currentUser, contract;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
window.nearInitPromise = initContract().then(function (_ref) {
  var contract = _ref.contract,
      currentUser = _ref.currentUser,
      nearConfig = _ref.nearConfig,
      walletConnection = _ref.walletConnection,
      nearApi = _ref.nearApi;
...
//# sourceMappingURL=frontend.cc7e1ddb.js.map